...
class TestJwtUnattendedAccess:
    ...
    async def _check_token_response(self, client_assertion_jwt, expected_status_code, expected_error,
    ...
    async def test_token_exchange_happy_path(self, test_app):
        # Given
        ...
        # When
        resp = await self.oauth.get_token_response(grant_type="token_exchange",
    ...
    async def test_token_exchange_invalid_client_assertion_type(self):
        ...
        resp = await self.oauth.get_token_response(
            grant_type="token_exchange",
            data={'client_assertion_type': 'Invalid',
                  'grant_type': 'urn:ietf:params:oauth:grant-type:token-exchange',
                  'subject_token_type': 'urn:ietf:params:oauth:token-type:id_token'})
    ...
    async def test_token_exchange_claims_assertion_invalid_kid(self):
        ...
        # When
        await self._check_token_response(client_assertion_jwt, expected_status_code, expected_error,
                                         expected_error_description)
