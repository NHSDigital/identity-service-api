...
class TestAuthorizationCode:
    ...
    def test_nhs_login_combined_user_restricted_flow_removes_external_scopes(
        self,
        external_scope,
        test_app_and_products,
        nhsd_apim_proxy_url,
...
class TestTokenExchange:
    ...
    def test_cis2_token_exchange_flow_removes_external_scopes(
        self,
        external_scope,
        test_app_and_products,
        nhsd_apim_proxy_url,
