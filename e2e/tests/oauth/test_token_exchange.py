...
class TestTokenExchange:
    ...
    # @pytest.mark.skip(reason="Skipped for now. Needs further investigation.")
    async def test_nhs_login_token_exchange_access_and_refresh_tokens_generated(self, scope, _jwt_keys,
                                                                                nhsd_apim_proxy_url,
        ...
        client_assertion = jwt.encode(client_claims, _jwt_keys["private_key_pem"],
                                      algorithm="RS512",
                                      headers={'kid': 'test-1'})
