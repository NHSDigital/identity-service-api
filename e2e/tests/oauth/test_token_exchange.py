...
class TestTokenExchange:
    ...
    @pytest.mark.nhsd_apim_authorization(
        access="healthcare_worker",
        level="aal2",
        login_form={"username": "aal2"},
        authentication="separate",
        force_new_token=True,
    )
    def test_cis2_token_exchange_happy_path_aal2(self, _nhsd_apim_auth_token_data):
        assert _nhsd_apim_auth_token_data["expires_in"] == "599"
        assert _nhsd_apim_auth_token_data["token_type"] == "Bearer"
        assert _nhsd_apim_auth_token_data["refresh_count"] == "0"
        assert (
    ...
    def test_cis2_token_exchange_refresh_token_aal2(
        self, _nhsd_apim_auth_token_data, nhsd_apim_proxy_url, _test_app_credentials
    ):
        resp = requests.post(
            nhsd_apim_proxy_url + "/token",
    ...
    def test_token_exchange_client_assertion_claims_errors_aal2(
        self,
        expected_response,
        expected_status_code,
        missing_or_invalid,
    ...
    def test_token_exchange_claims_assertion_invalid_jti_claim_aal2(
        self,
        _jwt_keys,
        nhsd_apim_proxy_url,
        cis2_subject_token_claims,
    ...
    def test_token_exchange_cis2_subject_token_claims_errors_aal2(
        self,
        expected_response,
        expected_status_code,
        missing_or_invalid,
    ...
    def test_cis2_token_exchange_access_tokens_valid_aal2(
        self,
        nhsd_apim_proxy_url,
        _create_function_scoped_test_app,
        _proxy_product_with_scope,
    ...
    def test_cis2_token_exchange_refresh_token_become_invalid_aal2(
        self,
        nhsd_apim_proxy_url,
        _test_app_credentials,
        claims,
    ...
    def test_cis2_refresh_tokens_generated_with_expected_expiry_separated_auth_aal2(
        self, _nhsd_apim_auth_token_data
    ):
        """
        Test that refresh tokens generated via CIS2 have an expiry time of 12 hours for separated authentication.
