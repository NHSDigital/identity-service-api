...
from e2e.scripts.config import OAUTH_URL, SERVICE_NAME
...
class TestSplunkUserAuthLogging:
    ...
    @pytest.mark.logging
    @pytest.mark.debug2
    async def test_populate_access_token_hash(self, test_app_and_product, helper):
        # async def test_populate_access_token_hash(self):
        # auth()
        # Given
