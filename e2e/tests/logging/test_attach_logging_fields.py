...
class TestAttachLoggingFields:
    ...
    def test_access_token_fields_for_logging_cis2_combined(
        ...
        assert token_attributes["auth_type"] == "user"
        assert token_attributes["auth_grant_type"] == "authorization_code"
        assert token_attributes["auth_level"] == "aal3"
        assert token_attributes["auth_provider"] == "nhs-cis2"
        assert token_attributes["auth_user_id"] == "656005750104"
