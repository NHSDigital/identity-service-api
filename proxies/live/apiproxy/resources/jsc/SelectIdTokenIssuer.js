...
if (iss == cis2Issuer) {
    ...
    jwksPath = "identity.ptl.api.platform.nhs.uk/auth/realms/NHS-Login-mock-internal-dev/protocol/openid-connect/certs "; //context.getVariable('identity-service-config.nhs_login.jwks_path');
}
